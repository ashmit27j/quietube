...
| Subscriptions feed | `subs_feed` | subs | css | low | · | · | · | Hides the subscriptions grid too. Most people want this ON for Deep Focus, OFF otherwise. |
...
- **Light** — Kills the worst of it. Recommendations gone, comments collapsed.
- **Music** — Playlists, mixes and related tracks stay. Visual noise goes.
- **Deep Focus** — Search-and-watch only. Everything else is gone.
